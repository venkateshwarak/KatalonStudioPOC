...
WebUI.setText(findTestObject('Object Repository/MAPsLogin/Page_Sign in to your account/input_Sign in_loginfmt'), 'venkateshwara.kayyala@parexelcloud.com')

WebUI.click(findTestObject('Object Repository/MAPsLogin/Page_Sign in to your account/input_Sign in_idSIButton9'))

WebUI.setEncryptedText(findTestObject('Object Repository/MAPsLogin/Page_Sign in to your account/input_Enter password_passwd'), 
    'ZPnMgbgKMNP0xCFbybRQBQ==')
